...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen p-8 bg-slate-950 text-white max-w-7xl mx-auto relative">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-4 rounded-2xl shadow-lg">
          ...
          {/* Feature 5: Ticking Countdown Timer */}
  ...
  >
    ...
    >
      ...
      {/* Interactive Match Hub Modal with 3 Tabs */}
      {selectedArena && (
        <div className="fixed inset-0 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl max-w-lg w-full text-white shadow-2xl relative">
            ...
            {/* TAB 1: Room Details with One-Click Copy Buttons */}
            {modalTab === "room" && (
            ...
            {/* TAB 2: Embedded YouTube Live Video Player */}
            {modalTab === "stream" && (
            ...
            {/* TAB 3: Feature 1 & 2 - Live Points Table / Standings */}
            {modalTab === "standings" && (
